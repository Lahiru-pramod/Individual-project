...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 03, 2021 at 03:02 PM
...
INSERT INTO `bills` (`bill_ID`, `Orderer_name`, `Orderer_ID`, `Booking_date`, `Booking_time`, `Adult`, `Child`, `package`, `Location`, `Address`, `Contact_no`, `Email`, `Meals`, `Adult_cost`, `Child_cost`, `Meal_cost`, `Total_cost`, `Guide`, `Ontime`) VALUES
...
(30, 'ygyug', '199802310093', '2021-11-18', '4 pm - 6 pm', 6, 2, 'normal', 'Madu', 'yingoiuyuo', '7698799', 'chamoddisala41@gamil.com', 'Yes', '6000.00', '600.00', '2160.00', '8760.00', 'N.K.Kumarasiri', '2021-11-02');
...
--
ALTER TABLE `bills`
  MODIFY `bill_ID` int(40) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=31;
